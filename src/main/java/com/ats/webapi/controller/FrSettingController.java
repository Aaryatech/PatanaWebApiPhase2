...
public class FrSettingController {
	...
	public @ResponseBody Info updateFrSettingBillNo(@RequestParam("frId") int frId,
		...
		try {
			...
			//System.out.println( "Fr setting Para Received for Update /updateFrSetting BillNo " + frId + "billNo " + sellBillNo);
			...
			//System.out.println( " /updateFrSettingBillNo Exce in Saving/Update fr Setting /FrSettingController " + e.getMessage());
			e.printStackTrace();
		}
	...
	public @ResponseBody Info updateFrSettingGrnGvnNo(@RequestParam("frId") int frId,
		...
		try {
			...
			//System.out.println( "Fr setting Para Received for Update /updateFrSettingGrnGvnNo " + frId + "grnGvnNo " + grnGvnNo);
			...
			//System.out.println( " /updateFrSettingGrnGvnNo Exce in Update fr Setting /FrSettingController " + e.getMessage());
			e.printStackTrace();
		}
	...
	public @ResponseBody Info updateFrSettingSpNo(@RequestParam("frId") int frId) {
		...
		try {
			...
			//System.out.println( "Fr setting Para Received for Update /updateFrSettingSpNo " + frId );
