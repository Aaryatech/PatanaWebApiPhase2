...
public interface GenerateBillRepository extends JpaRepository<GenerateBill, Integer> {
	...
	@Query(value=" SELECT t_order.order_id ,t_order.is_edit as sp_delivery_place,t_order.is_positive,t_order.fr_id, t_order.menu_id,t_order.grn_type ,t_order.item_id,t_order.edit_qty as order_qty,"
	...
	@Query(value=" SELECT t_order.order_id ,t_order.is_positive,t_order.is_edit as sp_delivery_place,t_order.fr_id, t_order.menu_id,t_order.grn_type,t_order.item_id,t_order.edit_qty as order_qty,"
