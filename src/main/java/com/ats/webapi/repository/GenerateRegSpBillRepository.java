...
public interface GenerateRegSpBillRepository extends JpaRepository<GenerateRegSpBill, Integer> {
	...
	/*
	 * @Query(
	 * value="SELECT t_regular_sp_cake.rsp_id , t_regular_sp_cake.fr_id, t_regular_sp_cake.fr_code ,t_regular_sp_cake.menu_id, t_regular_sp_cake.item_id,t_regular_sp_cake.qty, t_regular_sp_cake.rate,"
	 * +
	 * " t_regular_sp_cake.mrp, t_regular_sp_cake.rsp_delivery_dt, t_regular_sp_cake.rate_cat, CONCAT(m_franchisee.fr_name,' ',m_franchisee.fr_code) AS fr_name, m_franchisee.is_same_state, m_fr_menu_show.menu_title, m_item.item_name, m_item.item_grp1,m_item.item_grp2 ,"
	 * +
...
//	Sachin 01-02-2021
	...
	@Query(value="SELECT t_regular_sp_cake.rsp_id,coalesce((select item_hsncd from m_item_sup where m_item_sup.item_id=m_item.id and m_item_sup.del_status=0),'-') as hsn_code, t_regular_sp_cake.fr_id, t_regular_sp_cake.fr_code ,t_regular_sp_cake.menu_id, t_regular_sp_cake.item_id,t_regular_sp_cake.qty, t_regular_sp_cake.rate,"
