...
public interface SpCakeOrdersRepository extends JpaRepository<SpCakeOrders,Integer>{
	...
	@Transactional
	@Modifying	
	@Query("UPDATE SpCakeOrders t SET t.spBookForMobNo=:billNo  WHERE t.spOrderNo=:spOrderNo")	
	int updateBillNoInForSpCake(@Param("spOrderNo")int spOrderNo,@Param("billNo") String billNo);
