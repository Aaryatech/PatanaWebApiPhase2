...
public class GetBillsForFrServiceImpl implements GetBillsForFrService {
	...
	@Override
	public GetBillsForFrList getBillsForFrBetweenBillDate(int frId, String fromDate, String toDate) {
		GetBillsForFrList billsForFrList = new GetBillsForFrList();
		try {
			List<GetBillsForFr> getBillForFr = getBillsForFrRepository.getBillsForFrBetweenBillDate(frId, fromDate,toDate);
