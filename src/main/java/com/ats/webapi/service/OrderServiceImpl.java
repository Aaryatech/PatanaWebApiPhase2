...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public ItemOrderList searchOrderHistory(int catId, Date deliveryDate, int frId, int searchBy) {
		...
		try {
			...
			if (searchBy == 1) {
				...
				orderList = itemOrderHisRepository.findByMenuIdInAndOrderDate(catId, deliveryDate, frId);
			}
