...
public class SpCakeOrdersServiceImpl implements SpCakeOrdersService {
	...
	@Override
	public SpCkOrderHisList searchOrderHistory(String spDeliveryDt,String frCode, int searchBy) {
		...
		try {
			...
			if(searchBy==1) {
				...
				spCakeOrders=spCakeOrderHisRepository.findByMenuIdInAndSpOrderDt(spDeliveryDt,frCode);
			}
